...
def main():
    ...
    # Now print all categories and their products after all fetching and sorting is done
    # print(f"\nFound categories: {categories}\n")
    # for category in categories:
    #     print(f"\n=== Category: {category} ===\n")
    #     products = category_products.get(category, [])
    #     if not products:
    #         print("  No Amazon URLs found for this category.\n")
    #         continue
    #     for product in products:
    #         print(f"  Product: {product['title'] or 'N/A'}")
    #         print(f"    URL: {product['url'] or 'N/A'}")
    #         print(f"    Price: {product['price'] or 'N/A'}")
    #         print(f"    Rating: {product['average_rating'] or 'N/A'}")
